...
class DataTable extends React.Component {
	...
	sortColumn(e) {
		...
		if (col <= this.state.tableSortLimit) {
			const newdata = common.sort((a, b) => String(a[col]).localeCompare(String(b[col])));
...
DataTable.propTypes = {
	...
	scrollonmedium: PropTypes.bool,
	data: PropTypes.arrayOf(oneOfType([
		PropTypes.arrayOf(PropTypes.string),
		PropTypes.string,
		PropTypes.node,
	])).isRequired,
	restrictionTable: PropTypes.number,
	tableSortLimit: PropTypes.number,
