				...
				<span className={s.inputWrapper}>
					...
					/>
					{
						this.state.isValid && this.state.value && this.props.inputClass !== 'noClass' ? (
							...
							<span>
								<a href="javascript:void(0)" onMouseUp={this.timeoutClearinterval} onMouseDown={this.increaseFunction} onClick={this.increaseValue}>
									<span id={`${this.props.id}-addon`} className={`input-group-addon ${s.especialIcon}`}>
										<i className={increaseIcon} />
									</span>
								</a>
								<a href="javascript:void(0)" onMouseUp={this.timeoutClearinterval} onMouseDown={this.decreaseFunction} onClick={this.decreaseValue}>
									<span id={`${this.props.id}-addon`} className={`input-group-addon ${s.decreaseIcon}`}>
